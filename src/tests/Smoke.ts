...
async function Smoke() {
    ...
    try {
        ...
        console.log(generateReport(public_landing_en.testTotal, public_landing_en.passed, public_landing_en.failed));
        console.log(generateReport(public_landing_fr.testTotal, public_landing_fr.passed, public_landing_fr.failed));
    }
    catch (error: any) {
